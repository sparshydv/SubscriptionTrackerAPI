...
const testimonials: Testimonial[] = [
  {
    id: 1,
    quote: "I didn't realize I was paying for 8 subscriptions. This app saved me $500 in the first month.",
    name: "Guy Hawkins",
    username: "@guyhawkins",
    avatar: "https://images.unsplash.com/photo-1633332755192-727a05c4013d?fm=jpg&q=60&w=3000&auto=format&fit=crop",
  },
  {
    id: 2,
    quote: "I had no idea how much I was spending on subscriptions until I tried this. Within the first month I cut down my expenses and saved around $50.",
    name: "Karla Lynn",
    username: "@karlalynn8",
    avatar: "https://images.unsplash.com/photo-1494790108377-be9c29b29330?fm=jpg&q=60&w=3000&auto=format&fit=crop",
  },
  {
    id: 3,
    quote: "The renewal reminders are a lifesaver. I stopped getting surprise charges and saved over $40 in just a few weeks.",
    name: "Jane Cooper",
    username: "@janecooper",
    avatar: "https://images.unsplash.com/photo-1438761681033-6461ffad8d80?fm=jpg&q=60&w=3000&auto=format&fit=crop",
  },
  {
    id: 4,
    quote: "Seeing all my subscriptions in one dashboard was eye-opening. I cancelled three unused services and saved about $60 a month.",
    name: "Robert Chen",
    username: "@robertchen",
    avatar: "https://images.unsplash.com/photo-1500648767791-00dcc994a43e?fm=jpg&q=60&w=3000&auto=format&fit=crop",
  },
  {
    id: 5,
    quote: "I kept forgetting about small subscriptions charging me every month. After using this app, I found services I wasn't even using and saved $35 in the first month.",
    name: "Sarah Miller",
    username: "@sarahmiller",
    avatar: "https://images.unsplash.com/photo-1534528741775-53994a69daeb?fm=jpg&q=60&w=3000&auto=format&fit=crop",
  },
];
  ...
  return (
    <div className="px-4 py-8 sm:py-16 bg-gradient-to-b from-gray-50 to-white dark:from-gray-900 dark:to-gray-800 overflow-hidden">
      <div className="max-w-6xl mx-auto">
        ...
        >
          <span className="inline-block py-1 px-3 rounded-full bg-slate-100 dark:bg-slate-800 text-foreground font-medium text-xs sm:text-sm uppercase tracking-wider">
            Testimonials
          </span>
          <h3 className="text-2xl sm:text-3xl md:text-4xl font-bold text-foreground mt-3 sm:mt-4 px-4">
            People Are Already Saving Money
          </h3>
          <div className="w-16 sm:w-24 h-1 bg-foreground mx-auto mt-4 sm:mt-6"></div>
        </motion.div>
              ...
              {testimonials.map((testimonial) => (
                ...
                >
                  <motion.div
                    ...
                    whileHover={{
                      boxShadow:
                        "0 10px 15px -3px rgba(42, 157, 144, 0.1), 0 4px 6px -2px rgba(42, 157, 144, 0.05)",
                    }}
                  >
